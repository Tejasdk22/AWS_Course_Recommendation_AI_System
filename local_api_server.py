"""
Local API Server for Course Recommendations
Provides a working API endpoint for the frontend
"""
...
def course_recommendations():
    ...
    try:
        ...
        major = data.get('major', 'Business Analytics')
        student_type = data.get('studentType', 'Graduate')
        career_goal = data.get('careerGoal', 'Data Engineer')
...
if __name__ == '__main__':
    print('🚀 Starting Local API Server for Course Recommendations')
    print('=' * 60)
    print('✅ Server will run on http://localhost:5000')
    print('✅ CORS enabled for frontend integration')
    print('✅ Ready to serve course recommendations!')
    print()
