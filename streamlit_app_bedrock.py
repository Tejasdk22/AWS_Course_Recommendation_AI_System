#!/usr/bin/env python3
"""
Updated Streamlit App with Working Bedrock Integration
Uses the real multi-agent system with Bedrock instead of Lambda
"""
...
def display_recommendations(data):
    ...
    if data.get('used_bedrock'):
        st.markdown('<div class="bedrock-status">🤖 Powered by Amazon Bedrock</div>', unsafe_allow_html=True)
    ...
    with st.expander("📊 Detailed Job Market Analysis"):
        st.markdown(data['job_market_insights'])
    
    with st.expander("📚 Detailed Course Recommendations"):
        st.markdown(data['course_recommendations'])
    
    with st.expander("🎯 Detailed Career Matching Analysis"):
        st.markdown(data['career_matching_analysis'])
    
    with st.expander("🚀 Detailed Project Suggestions"):
...
def main():
    ...
    <div class="main-header">
        ...
        <div class="bedrock-badge">🤖 Powered by Amazon Bedrock Multi-Agent System</div>
    </div>
    """, unsafe_allow_html=True)
    ...
    with st.sidebar:
        ...
        # Ready section
        st.markdown("---")
        st.markdown("### 🚀 Ready to Get AI Recommendations?")
        ...
        if st.button("Get AI-Powered Recommendations", type="primary", use_container_width=True):
            ...
            with st.spinner("🤖 AI agents are analyzing your academic path and generating personalized recommendations..."):
            ...
            st.success("✅ AI-powered recommendations generated successfully!")
